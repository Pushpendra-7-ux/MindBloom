          ...
          builder: (context, setSheetState) {
            return Consumer(
              builder: (context, ref, child) {
                ...
                final categories = ['All', 'Streaks', 'Mindfulness', 'Hydration', 'Gratitude', 'Habits'];

                final filteredBadges = badgesState.badges.where((b) {
                  if (selectedCategory == 'All') return true;
                  return b.category.name.toLowerCase() == selectedCategory.toLowerCase();
                }).toList();
                    ...
                    children: [
                      ...
                      Expanded(
                        child: filteredBadges.isEmpty
                            ? const Center(child: Text('No milestones found for this category.'))
                            : GridView.builder(
